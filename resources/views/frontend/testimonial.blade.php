...
<head>
    ...
    <title>{{ __('words.titleTestimoial') }}</title>
...
<style>
    body{
        background-image: url({{ asset('front/assets/img/bgTestimonial.jpg')}});
        height: 100vh;
        width: 100%;
