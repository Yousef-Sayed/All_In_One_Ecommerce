					...
					<div class="login-box bg-white box-shadow border-radius-10">
						<div class="login-title">
							...
							<p class="text-center">
                                ...
                                href="{{ route('signup') }}">{{ __('words.signUpNow') }}</a></p>
						</div>
							...
							<div class="row pb-30">
								<div class="col-6">
									<div class="custom-control custom-checkbox">
										...
										<label class="custom-control-label" for="customCheck1">{{ __('words.remember') }}</label>
									</div>
								</div>
								<div class="col-6">
									<div class="forgot-password"><a href="{{ route('forgot') }}">{{ __('words.forgotPassword') }}</a></div>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-12">
									...
									<div class="font-16 weight-600 pt-10 pb-10 text-center" data-color="#707373">{{ __('words.or') }}</div>
									<div class="input-group mb-2">
										<a class="btn btn-dark btn-sm btn-block"
                                        style=" background-color: #4285f4 !important; color: white !important;border-color:  #4285f4 !important;"
                                        href="{{ route('AG') }}"><i class="fab fa-google text-white" style="font-size: 16px; margin:0 5px;"></i> {{ __('words.loginWG') }}</a>
									</div>
									<div class="input-group mb-0">
										<a class="btn btn-dark btn-sm btn-block"
                                        style=" background-color: #1877f2 !important; color: white !important;border-color:  #1877f2 !important;"
                                        href="{{ route('AF') }}"><i class="fab fa-facebook-f" style="font-size: 16px; margin:0 5px;"></i> {{ __('words.loginWF') }}</a>
									</div>
								</div>
							</div>
						</form>
