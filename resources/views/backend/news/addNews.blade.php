...
@section('content')
    <div class="containers" >
        ...
        @endif
            <form class="w-100" method="POST" enctype="multipart/form-data" action="{{ route('news.store') }}">
                @csrf
                <ul class="profile-edit-list row p-0 m-0">
                    ...
                    <li class="weight-500 col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="content" id="bodyInput" class="form-control">{{ old('body') }}</textarea>
                    ...
                    <div class="form-group pt-4 text-center w-100 ">
                        <input type="submit" class="btn p-3 font-weight-bold w-25 bg-blue text-light" value="{{ __('words.addNews') }}">
                    </div>
                </ul>
            </form>
        </div>
