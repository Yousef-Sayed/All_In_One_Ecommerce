...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{ asset('backend/vendors/styles/icon-font.css') }}">
...
<body>
							...
							<ul>
								<li>
									<a href="{{ asset('/lang/ar') }}">
										<img src="{{ asset('backend/vendors/images/flag.png') }}" alt="">
										<h3>العربيه</h3>
									</a>
								</li>
								<li>
									<a href="{{ asset('/lang/en') }}">
										<img src="{{ asset('backend/vendors/images/epsilon.png') }}" alt="">
										<h3>English</h3>
									</a>
								</li>
							</ul>
			...
			<div class="user-info-dropdown">
				<div class="dropdown">
					...
					<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
						<a class="dropdown-item" href="{{ route('admin.profile') }}"><i class="fas fa-user-edit"></i> {{ __('words.profile') }}</a>
						<a class="dropdown-item" href="{{ route('admin.logout') }}"><i class="fas fa-sign-out-alt"></i> {{ __('words.signOut') }}</a>
					</div>
				</div>
			</div>
		</div>
				...
				<ul id="accordion-menu">
					<li>
						<a href="{{ route('admin.home') }}" class="dropdown-toggle no-arrow">
                            ...
                            <span class="mtext">{{ __('words.dashboard') }}
						</a>
					</li>
                    @can('show',Auth::guard('admin')->user())
                        <li>
                            <a href="{{ route('admins') }}" class="dropdown-toggle no-arrow">
                                <i class="fas fa-user-shield"></i>
                                <span class="mtext">{{ __('words.admines') }} </span>
                            </a>
                        </li>
                    @endcan
					...
					<li>
						<a href="{{ route('users') }}" class="dropdown-toggle no-arrow">
                            ...
                            <span class="mtext">{{ __('words.customers') }} </span>
						</a>
					</li>
                    ...
                    <li>
						<a href="{{ route('category.index') }}" class="dropdown-toggle no-arrow">
                            ...
                            <span class="mtext">{{ __('words.categories') }}
						</a>
					</li>

					<li>
						<a href="{{ route('prodecut.index') }}" class="dropdown-toggle no-arrow">
                            <i class="fab fa-product-hunt"></i>
                            <span class="mtext">{{ __('words.prodecuts') }} </span>
						</a>
					</li>

					<li>
						<a href="{{ route('shipping.index') }}" class="dropdown-toggle no-arrow">
                            <i class="fas fa-truck"></i>
                            <span class="mtext">{{ __('words.shipping') }} </span>
						</a>
					</li>
					<li>
						<a href="{{ route('orders.index') }}" class="dropdown-toggle no-arrow">
                            <i class="fas fa-box"></i>
                            <span class="mtext">{{ __('words.orders') }} </span>
						</a>
					</li>

					<li>
						<a href="{{ route('admin.testimonial') }}" class="dropdown-toggle no-arrow">
                            <i class="far fa-comments"></i>
                            <span class="mtext">{{ __('words.testimonial') }} </span>
						</a>
					</li>

					<li>
						<a href="{{ route('news.index') }}" class="dropdown-toggle no-arrow">
                            <i class="far fa-newspaper"></i>
                            <span class="mtext">{{ __('words.news') }} </span>
						</a>
					</li>
                    @can('show',Auth::guard('admin')->user())
                        <li>
                            <a href="{{ route('logs.index') }}" class="dropdown-toggle no-arrow">
                                <i class="far fa-clock"></i>
                                <span class="mtext">{{ __('words.logs') }} </span>
                            </a>
                        </li>
                    @endcan
				</ul>
	...
	<script src="{{ asset('backend/vendors/scripts/script.js') }}"></script>
