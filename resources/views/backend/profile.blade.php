...
<body>
    ...
    <a href="{{ route('admin.home') }}" class="text-center overflow-hidden p-3 logo" style="z-index: 100">
    ...
    <div class="container">
        <div class="profile-setting">
            ...
            <form class="w-100 d-flex justify-content-center" method="POST" action="{{ route('profileUpdateAdmin') }}" enctype="multipart/form-data">
                @csrf
                <ul class="profile-edit-list row w-100 justify-content-center">
                    <li class="weight-500 col-md-6">
                        <div class="form-group text-center m-2">
                            <img src="{{ asset(Auth::guard('admin')->user()->profile_photo_path)}}" class="img" id="imageElementId" alt="">
                        ...
                        <div class="form-group m-2">
                            ...
                            <input name="name" class="form-control form-control-lg" type="text" value="{{ Auth::guard('admin')->user()->name }}">
                        ...
                        <div class="form-group m-2">
                            ...
                            <input name="email" class="form-control form-control-lg" type="text" value="{{ Auth::guard('admin')->user()->email }}">
