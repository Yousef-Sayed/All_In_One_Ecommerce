...
@section('content')
    <div class="containers" >
        <div class="profile-setting">
            <form class="w-100 d-flex justify-content-center" method="POST" enctype="multipart/form-data" action="{{ route('shipping.store') }}">
                @csrf
                <ul class="profile-edit-list row">
                    ...
                    <div class="form-group pt-4 text-center w-100 ">
                        <input type="submit" class="btn p-3 font-weight-bold w-25 bg-blue text-light" value="{{ __('words.addShiping') }}">
                    </div>
                </ul>
            </form>
        </div>
