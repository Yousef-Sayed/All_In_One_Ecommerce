...
<div class="product-section mt-100 mb-100">
    <div class="container">
        ...
        <div class="row">
            @foreach (DB::table('categories')->get()->where('id',$cats)->whereNull('deleted_at') as $cat)
                ...
                @endif
                @foreach (DB::table('prodecuts')->get()->where('categoryId',$cats)->whereNull('deleted_at') as $show)
